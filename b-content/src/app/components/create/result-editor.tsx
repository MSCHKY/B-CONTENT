                ...
                <div className="space-y-4">
                    ...
                    {imageError && (
                        <div className="rounded-lg bg-red-500/10 border border-red-500/30 p-3 text-sm text-red-400 animate-fade-in-up flex items-center justify-between">
                            ...
                            <button type="button" aria-label="Close error message" title="Close error message" onClick={() => setImageError(null)} className="text-red-400 hover:text-red-300 ml-2 rounded outline-none focus-visible:ring-2 focus-visible:ring-red-400">✕</button>
                        </div>
                    )}
                </div>
            </div>

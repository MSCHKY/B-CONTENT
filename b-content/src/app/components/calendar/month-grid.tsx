...
export function MonthGrid({
    ...
    // ⚡ Bolt: O(1) lookup map for scheduled posts instead of O(N*M) array filtering in render loop
    ...
    // ⚡ Bolt: O(1) lookup set for conflict dates instead of O(N*M) array some in render loop
